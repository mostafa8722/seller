...
export default {
    ...
    setup(){
        ...
        const items=[{text:'ماهانه',value:'ماهانه'},{text:'سالانه',value:'سالانه'},{text:'روزانه',value:'روزانه'},{text:'text2',value:'value2'},{text:'text2',value:'value2'},{text:'text2',value:'value2'}]
